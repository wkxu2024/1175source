  ...
  ("camp",mnf_scale_picture,
   ...
   [
    ...
    [
      ...
      ("camp_action_1",
        [
          # (eq,"$cheat_mode",1) ###(((camp_action_1 OLD)))
          (neq, "$cheat_mode", 0), ###(((camp_action_1 NEW)))
        ],
        "Walk around.", ###((({!}Cheat: Walk around.)))
        [
          (set_jump_mission,"mt_ai_training"),
  ...
  ("camp_cheat",0,
   ...
   [
    ...
    [
      ...
      ("camp_cheat_change_weather",[] ###((("camp_cheat_find_item")))
        , "Change weather..",
        [
      ...
      ("cheat_faction_orders_a", ###((("cheat_faction_orders")))
        [(ge,"$cheat_mode",1)]
      ...
      ("cheat_faction_orders_b", ###((("cheat_faction_orders")))
        [(ge, "$cheat_mode", 1),
	       (neq,"$cheat_mode",3)]
      ...
      ("cheat_faction_orders_c", ###((("cheat_faction_orders")))
        [(ge, "$cheat_mode", 1),
	       (neq,"$cheat_mode",4)]
   ...
   [
    ...
    [
      ...
      ("action_modify_banner",
        [
          # (eq, "$cheat_mode", 1), ###(((modify_banner OLD)))
          (neq, "$cheat_mode", 0), ###(((modify_banner NEW)))
        ],
       "Modify your banner.", ###((({!}Cheat: Modify your banner.)))
       [
           (start_presentation, "prsnt_banner_selection"),
           #(start_presentation, "prsnt_custom_banner"),
        ]
    ...
    [
      ...
      ("request_meeting_commander",[],
       ...
       # find all possible npcs, fill them into temp_array_a
        ...
        (store_div, ":num_pages", "$num_castle_meeting_troops", 9), ##
        (store_mod, ":mod", "$num_castle_meeting_troops", 9), ##
        (val_min, ":mod", 1),
...
##  ),
    ...
    [
      ...
      ("meet_with_village_elder",
        ...
        [
          (try_begin),
            (call_script, "script_cf_enter_center_location_bandit_check"),
          (else_try),
            (party_get_slot, ":meeting_scene", "$current_town", slot_town_center),
            (modify_visitors_at_site, ":meeting_scene"),
            (reset_visitors),
            (party_get_slot, ":meeting_troop", "$current_town", slot_town_elder),
            (set_visitor, 11, ":meeting_troop"),
            (set_jump_mission, "mt_village_center"),
            (jump_to_scene, ":meeting_scene"),
      ...
      ("village_leave",[],"Leave...",
        [
          ###(((auto_trade
          (try_begin),
            (eq, "$g_auto_sell_equipments_when_leaving", 1),
            (call_script, "script_auto_sell", 0),
          (try_end),
          (try_begin),
            (eq, "$g_auto_sell_goods_when_leaving", 1),
            (call_script, "script_auto_sell", 1),
          (try_end),
          (try_begin),
            (eq, "$g_auto_buy_goods_when_leaving", 1),
            (call_script, "script_auto_buy"),
          (try_end),
          ###)))
          (change_screen_return,0),
        ]),
      ...
      ###(((village_cheat
      ("village_cheat",[(gt, "$cheat_mode", 0),],
        "CHEAT MENU!",
        [
          (jump_to_menu, "mnu_village_cheat"),
        ]),
      ###)))
    ],
  ),
  ...
  ("village_cheat",0,
    ...
    [
      ###(((cheat_relation
      ("cheat_village_relation",
      [
        (gt, "$cheat_mode", 0),
      ], 
      "CHEAT: Increase your relation with this village.",
      [
...
#		(try_end),
    ...
    [
      ...
      ###(((town_meeting
      ("town_meeting",[(eq, "$sneaked_into_town", 0),],
        "Meet with someone.",
        [
          # find all possible npcs, fill them into temp_array_a
          (assign, ":slot_no", 0),
          (try_begin), ##player_spouse
          ...
          (try_for_range, ":troop_no", active_npcs_begin, active_npcs_end),
            ...
            (try_begin),
              (call_script, "script_get_troop_attached_party", ":troop_no"),
              (eq, "$current_town", reg0),
              (troop_set_slot, "trp_temp_array_a", ":slot_no", ":troop_no"),
              (val_add, ":slot_no", 1),
            (try_end),

          (else_try), ##Lords wishing to pledge allegiance
            ...
            (try_begin),
              ...
              (neg|troop_slot_ge, ":troop_no", slot_troop_prisoner_of_party, 0),
              (neq, ":troop_no", "$g_player_minister"),
              (troop_set_slot, "trp_temp_array_a", ":slot_no", ":troop_no"),
              (val_add, ":slot_no", 1),
            (try_end),
...
#           (scene_slot_eq,  ":scene", slot_scene_visited, 1), #check if scene has been visited before to allow entry from menu. Otherwise scene will only be accessible from the town center.
       ...
       "Enter the arena{s1}.", ###(((join_tournament NEW)))
       [
           (try_begin),
             (this_or_next|eq,"$all_doors_locked",1),
             (eq,"$town_nighttime",1),
	...
	(gt, "$love_interest_in_town", 0),
      ...
      ("trade_with_merchants",
       [
         ...
         "Go to the marketplace (Guild master here).", ###(((meet_with_guild_master)))
         [
           (try_begin),
             (call_script, "script_cf_enter_center_location_bandit_check"),
           (else_try),
      ...
      "Sort the garrison.",
      [
        (assign, "$g_prsnt_param_1", "$g_encountered_party"),
        (assign, ":sort_prisoners", 0),
        (assign, "$g_prsnt_param_2", ":sort_prisoners"),
        (assign, ":ascending", 0),
        (assign, "$g_prsnt_param_3", ":ascending"),
        (assign, ":selected_ord", -1),
        (assign, "$g_prsnt_param_4", ":selected_ord"),
        (assign, ":selected_ord_type", -1), # 0:faction, 1:class
        (assign, "$g_prsnt_param_5", ":selected_ord_type"),
...
##          ]),
  ...
  ("town_cheat",0,
    ...
    [
      ...
      "CHEAT: Increase your relation with this town.",
      [
        (call_script, "script_change_player_relation_with_center", "$current_town", 5),
      ]),
      ###)))
      ...
      ###(((remove_ships
      ("remove_ships",[(eq, "$cheat_mode", 1),],"CHEAT: Remove all ships.",
        [
      ...
      ###)))
      ###(((show_distance
      ("show_distance",[(eq, "$cheat_mode", 1),],"CHEAT: Show distance.",
        [
          (try_for_range, ":town", towns_begin, towns_end),
            (str_store_party_name, s0, ":town"),
            (store_distance_to_party_from_party, reg0, "$current_town", ":town"),
            (display_message, "@{s0}:{reg0}", 0xFF00FF),
          (try_end),
        ]),
      ###)))
  ...
  ###(((town_meeting
  ("town_meeting",mnf_scale_picture,
    "With whom do you want to meet?",
    "none",
    [
      (call_script, "script_set_town_picture"),
    ...
    [
      ...
      ("castle_meeting_character"+str(x+1),
        ...
        [
          ...
          (jump_to_menu, "mnu_town"),
          (try_begin), ##player cannot enter court
            (this_or_next|neq, "$players_kingdom", "$g_encountered_party_faction"),
            (neg|troop_slot_ge, "trp_player", slot_troop_renown, 50),
            (neg|troop_slot_ge, "trp_player", slot_troop_renown, 125),
            (neq, "$g_player_eligible_feast_center_no", "$current_town"),
            ...
            ##according to mnu_castle_meeting_selected
            (modify_visitors_at_site,"scn_conversation_scene"),
            (reset_visitors),
            (set_visitor,0,"trp_player"),
            (set_visitor,17,"$castle_meeting_selected_troop"),
            ...
            (change_screen_map_conversation, "$castle_meeting_selected_troop"),
          (else_try),
            (party_get_slot, ":meeting_scene", "$current_town", slot_town_castle),
            (modify_visitors_at_site, ":meeting_scene"),
            (reset_visitors),
    ...
    [
      ...
      ("continue",[],"Continue...",
       [
        ...
        (assign, "$temp", 0), # $temp: cur page
        (store_div, ":num_pages", "$temp_3", 9), ##
        (store_mod, ":mod", "$temp_3", 9), ##
        (val_min, ":mod", 1),
        (store_add, "$temp_2", ":num_pages", ":mod"), # $temp_2: total pages
        (jump_to_menu, "mnu_minister_appoint"),
       ]),
      ###)))
    ###(((minister_appoint OLD
    #   ("appoint_spouse",[
	  # (troop_slot_ge, "trp_player", slot_troop_spouse, 1),
	  # (troop_get_slot, ":player_spouse", "trp_player", slot_troop_spouse),
	  # (neg|troop_slot_eq, ":player_spouse", slot_troop_occupation, slto_kingdom_hero),
...
#          (try_end),
    ...
    [
      ...
      ("all_items",[],"View all items.",
        [
          ...
          (try_begin),
            (eq, "$cheat_mode", 0),
            (assign, "$g_only_show_merchandise", 1),
          (try_end),
          (try_begin),
            (eq, "$cheat_mode", 0),
            (assign, "$g_show_all_modifiers", 0),
          (try_end),
          (start_presentation, "prsnt_all_items"),
        ]),
      ###)))
      ###(((all_troops
      ("all_troops",[],"View all troops.",
        [
          (assign, ":selected_troop", "trp_player"),
          (assign, "$g_prsnt_param_1", ":selected_troop"),
          (assign, ":cur_page", 0),
          (assign, "$g_prsnt_param_2", ":cur_page"),
          (assign, ":num_troops", 0),
          (assign, "$g_prsnt_param_3", ":num_troops"),
          (assign, ":cheat_get_troop", 1),
          (assign, "$g_prsnt_param_4", ":cheat_get_troop"),
      ...
      ###)))
      ###(((troop_trees
      ("troop_trees",[],"View troop trees.",
        [
          (assign, ":selected_page", 0),
          (assign, "$g_prsnt_param_5", ":selected_page"),
          (start_presentation, "prsnt_troop_trees"),
        ]),
      ###)))
      ###(((relations_report
      ("relations_report",[],"View relations with factions and lords.",
        [
      ...
      ###(((recruit_all_npcs
      ("recruit_all_npcs",[(gt,"$cheat_mode",0),],
        "CHEAT: Recruit all companions.",
        [
          (call_script, "script_recruit_all_npcs"),
        ]),
      ###)))
      ###(((show_bandit_lair
      ("show_bandit_lair",[(gt,"$cheat_mode",0),],
        ...
        [
          (try_for_parties, ":cur_party"),
            ...
            (eq, ":party_type", spt_bandit_lair),
            (party_set_flags, ":cur_party", pf_disabled, slot_party_type),
          (try_end),
        ]),
      ###)))
      ###(((force_peace
      ("force_peace",
        ...
        "CHEAT: Make peace with...",
        [
         (jump_to_menu, "mnu_force_peace"),
        ]),
      ###)))
      ###(((force_war
      ("force_war",
        ...
        "CHEAT: Declare war on...",
        [
         (jump_to_menu, "mnu_force_war"),
        ]),
      ###)))
      ###(((debug_message_off
      ("debug_message_off",
  ...
  ###(((force_peace
  ("force_peace", 0,
    "Which faction do you want to make peace with?",
    "none",
    [],
    [
      ("force_peace_faction"+str(x+1),
        [
          (assign, ":faction_no", npc_kingdoms_begin),
          (val_add, ":faction_no", x),
        ...
        [
          (assign, ":faction_no", npc_kingdoms_begin),
          (val_add, ":faction_no", x),
          (call_script, "script_diplomacy_start_peace_between_kingdoms",  "$players_kingdom", ":faction_no", 1),
        ]) for x in range(0, 6)
    ]+[
      ("camp_action_4",[],"Back to camp menu.",
        [
  ...
  ###(((force_war
  ("force_war", 0,
    "Which faction do you want to Declare war on?",
    "none",
    [],
    [
      ("force_war_faction"+str(x+1),
        [
          (assign, ":faction_no", npc_kingdoms_begin),
          (val_add, ":faction_no", x),
          (neq, ":faction_no", "$players_kingdom"),
        ...
        [
          (assign, ":faction_no", npc_kingdoms_begin),
          (val_add, ":faction_no", x),
          (call_script, "script_diplomacy_start_war_between_kingdoms",  "$players_kingdom", ":faction_no", 1),
        ]) for x in range(0, 6)
    ]+[
      ("camp_action_4",[],"Back to camp menu.",
        [
