...
slot_item_modifier_multiplier      = 62 ###(((manage_inventory)))
###(((auto_trade
slot_item_type_for_sell						=63
slot_item_auto_sell_price					=64
slot_item_auto_buy_price					=65
###)))
...
slot_troop_not_auto_equip      = 165 ###(((manage_inventory)))

###(((toggle_weapons
slot_2nd_weapons_1             = 166
slot_2nd_weapons_2             = 167
slot_2nd_weapons_3             = 168
slot_2nd_weapons_4             = 169
slot_troop_weapons_set_no      = 170
###)))
###(((sort_troops
slot_troop_class_order				 = 171
slot_troop_faction_order			 = 172
###)))
slot_troop_npc_banner_scene_prop = 173 ###(((npc_banners)))


###(((troop_slots_reserved_for_relations_start        = 165))) trp_kingdom_heroes_including_player_begin = 193
troop_slots_reserved_for_relations_start        = 175 #this is based on id_troops, and might change
...
# banners_end_offset = 136 ###(((banners OLD)))
banners_end_offset = 145 ###(((banners NEW)))

###(((npc_banners
npc_banner_scene_props_begin = "spr_banner_g02"
###)))
