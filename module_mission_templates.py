    ...
    [
      ...
      [
        ...
        (try_begin),
          ...
          # (agent_set_team, ":agent_no", 0), ###(((prison_break OLD)))
          ###(((prison_break FIX
          (get_player_agent_no, ":player_agent"),
          (agent_get_team, ":player_team", ":player_agent"),
...
#used for torunament master scene
    ...
    tournament_triggers + mod_commom_triggers ###((()))
  ),
...
##  ),
  ...
  (
    ...
    [
      ...
      (0, 0, ti_once, [], [(assign, "$game_key_battle_map", key_m),]), ###((()))
    ] + mod_commom_triggers, ###((()))
  ),
