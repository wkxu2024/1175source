...
#     (position_get_x, reg51, pos1),
#     (position_get_y, reg52, pos1),
...
#     (store_add, ":pos_x", reg51, ":x_offset"),
#     (store_add, ":pos_y", reg52, ":y_offset"),
#     (position_set_x, pos1, ":pos_x"),
#     (position_set_y, pos1, ":pos_y"),
#     (overlay_set_position, "$pos_tool", pos1),
#     (overlay_set_text, "$pos_tool", "@({reg51}, {reg52})"),
#     # (overlay_set_color, "$pos_tool", 0xFFFFFF),
#   ]),
# ]
###)))
  ...
  ("banner_selection",0,mesh_load_window,[
      (ti_on_presentation_load,
       [(set_fixed_point_multiplier, 1000),
        ...
        (create_text_overlay, reg1, s1, tf_center_justify),
        (position_set_x, pos1, 500),
        (position_set_y, pos1, 670), ###(((OLD:600)))
        (overlay_set_position, reg1, pos1),
        (overlay_set_text, reg1, s1),

        ###(((banner_selection NEW
        (str_clear, s0),
      ...
      (ti_on_presentation_event_state_change,
       [(store_trigger_param_1, ":object"),
        ...
        ###(((banner_selection NEW
        (store_sub, ":selected_banner", ":object", 2),
        ...
        ###)))
          ...
          (assign, "$g_troop_take_back_banner", ":troop_to_change"), ###(((give back the lord's banner)))
          ...
          (try_for_range, ":cur_center", walled_centers_begin, walled_centers_end),
            ...
            (try_end),
          (try_end),
        # (try_end), ###(((banner_selection OLD)))
        (presentation_set_duration, 0), ###(((banner_selection NEW)))
        ]),
      (ti_on_presentation_run,
       [(try_begin),
          (this_or_next|key_clicked, key_space),
...
##            (call_script, "script_update_order_panel", ":player_team"),
      ...
      (ti_on_presentation_run,
       [(store_trigger_param_1, ":cur_time"),
        ...
        (try_begin),
          (gt, ":cur_time", 200),
          (this_or_next|key_clicked, "$game_key_battle_map"), ###(((battle_map)))
  ...
  ("manage_inventory", 0, mesh_inventory_window, [
    (ti_on_presentation_load, [
      ...
      (try_for_range, ":stack_no", 0, ":num_heros"),
        (party_stack_get_troop_id,":stack_troop","p_main_party_heros",":stack_no"),
      ...
      # tips
      (create_in_game_button_overlay, "$g_presentation_obj_admin_panel_5", "@Tips"),
      (overlay_set_color, "$g_presentation_obj_admin_panel_5", 0xFFFFFF),
      (position_set_x, pos1, 835),
      (position_set_y, pos1, 100),
      (overlay_set_position, "$g_presentation_obj_admin_panel_5", pos1),
      ...
      (try_for_range, ":inv_slot_no", 4, 8),
        ...
        #   (ge, ":inv_slot_no", 4),
          ...
          (try_end),
        # (try_end),
        # (item_get_weight, ":cur_encumbrance", ":item"), #
        # (assign, reg0, ":cur_encumbrance"),
        # (display_message, "@{reg0}", 0x000000),
        # (val_add, ":encumbrance", ":cur_encumbrance"),
      (try_end),
      ...
      (str_store_string, s2, "@{s2}^^{s1}"),
      # (store_mod, reg0, ":encumbrance", 1000),
      # (store_div, reg1, ":encumbrance", 1000),
      # (str_store_string, s1, "@Encumbrance: {reg1}.{reg0}"),
      # (str_store_string, s2, "@{s2}^^{s1}"),
      ...
      # ## talk
      # (create_game_button_overlay, "$g_presentation_obj_admin_panel_9", "@Talk", tf_center_justify),
      # (position_set_x, pos1, 580),
      # (position_set_y, pos1, 25),
      # (overlay_set_position, "$g_presentation_obj_admin_panel_9", pos1),
      # (try_begin),
      #   (eq, ":selected_troop", "trp_player"),
      #   (overlay_set_display, "$g_presentation_obj_admin_panel_9"),
      # (try_end),
    ...
    (ti_on_presentation_mouse_press,[
      ...
      (assign, ":selected_troop", "$g_prsnt_param_1"),
      (assign, ":exchange", -1), # 0: no change, 1: inventory slots exchange, 2: equipment changed, 3: armors and encumbrance changed
      (try_begin), 
          ...
          (try_begin),
            ...
            (else_try),
              ...
              (else_try),
                (ge, ":old_slot", 10),
                (try_begin),
                  (troop_slot_eq, "trp_temp_array_c", ":old_slot", 1), # can use
              ...
              (else_try),
                (ge, ":new_slot", 10),
                (try_begin),
                  (troop_slot_eq, "trp_temp_array_c", ":new_slot", 1), # can use
                  (try_begin),
                    (gt, ":new_item", -1),
            ...
            (try_begin),
              ...
              (try_begin),
                ...
                (try_for_range, ":new_slot", 0, ":end_cond"),
                  ...
                  (assign, ":new_slot_type", reg0),
                  (try_begin),
                    (eq, ":new_slot_type", itp_type_one_handed_wpn), # weapons, don't change
    ...
    (ti_on_presentation_run, [
      ...
      (assign, ":selected_troop", "$g_prsnt_param_1"),
      (party_get_num_companion_stacks, ":num_heros", "p_main_party_heros"),
      (try_for_range, ":stack_no", 0, ":num_heros"),
        (party_stack_get_troop_id, ":stack_troop", "p_main_party_heros", ":stack_no"),
        (eq, ":stack_troop", ":selected_troop"),
      ...
      (try_begin),
        ...
        (party_stack_get_troop_id, ":new_troop", "p_main_party_heros", ":new_stack_no"),
    ...
    (ti_on_presentation_event_state_change,[
      ...
      # (else_try), # talk
      #   (eq, ":object", "$g_presentation_obj_admin_panel_9"),
      #   (assign, ":meeting_scene", "scn_conversation_scene"),
      ...
      (else_try), # tips
        (eq, ":object", "$g_presentation_obj_admin_panel_5"),
        (assign, ":continue", 0),
        (tutorial_box, "@Left Mouse - drag: exchange items manually^Right Mouse - click: put it back, or equip hero with it, or take it off\
^^Forward Key: switch to the previous hero^Backward Key: switch to the next hero^Left Key: switch to the first hero^Right Key: switch to the last hero^Action Key: toggle the set of weapons\
^^Locked item won't be upgraded, sorted, or sold automatically^^When you are done, every hero will use the other set of weapons if current set is empty", "@Tips"),
      (try_end),
      ...
      (try_for_range, ":hero_obj_slot_no", 0, ":num_heros"),
        ...
        (party_stack_get_troop_id, ":selected_troop", "p_main_party_heros", ":hero_obj_slot_no"),
        (assign, "$g_prsnt_param_1", ":selected_troop"),
        (start_presentation, "prsnt_manage_inventory"),
      (try_end),
  ...
  ("all_items", 0, mesh_load_window, [
    (ti_on_presentation_load, [
      ...
      (position_set_y, pos1, 600),
      (overlay_set_position, "$g_presentation_obj_admin_panel_1", pos1),
      (overlay_add_item, "$g_presentation_obj_admin_panel_1", "@Melee Weapons"),
      (overlay_add_item, "$g_presentation_obj_admin_panel_1", "@Range Weapons"),
      ...
      (create_text_overlay, reg1, "@Only show merchandise", tf_left_align),
      ...
      (position_set_y, pos1, 650),
      (overlay_set_position, "$g_presentation_obj_admin_panel_2", pos1),
      (overlay_set_val, "$g_presentation_obj_admin_panel_2", "$g_only_show_merchandise"),
      (try_begin),
        (eq, "$cheat_mode", 0),
      ...
      (create_text_overlay, reg1, "@Show all modifiers", tf_left_align),
      (position_set_x, pos1, 720),
      (position_set_y, pos1, 550),
      (overlay_set_position, reg1, pos1),
      ...
      (position_set_y, pos1, 550),
      (overlay_set_position, "$g_presentation_obj_admin_panel_3", pos1),
      (overlay_set_val, "$g_presentation_obj_admin_panel_3", "$g_show_all_modifiers"),
      (try_begin),
        (eq, "$cheat_mode", 0),
        (overlay_set_display, reg1, 0),
      ...
      ## item modifiers
      (assign, ":cur_imod_page", 0),
      (create_combo_button_overlay, "$g_presentation_obj_admin_panel_4"),
      (position_set_x, pos1, 840),
      (position_set_y, pos1, 500),
      (overlay_set_position, "$g_presentation_obj_admin_panel_4", pos1),
      (try_begin),
        (eq, "$g_show_all_modifiers", 0),
        (overlay_add_item, "$g_presentation_obj_admin_panel_4", "str_imod_plain"),
        (overlay_set_val, "$g_presentation_obj_admin_panel_4", 0),
        (troop_set_slot, "trp_temp_array_d", 0, 0),
      (else_try),
        (try_for_range, ":cur_imod_str", "str_imod_plain", "str_imod_end"),
          (store_sub, ":cur_imod", ":cur_imod_str", "str_imod_plain"),
          (overlay_add_item, "$g_presentation_obj_admin_panel_4", ":cur_imod_str"),
          (troop_set_slot, "trp_temp_array_d", ":cur_imod_page", ":cur_imod"),
          (val_add, ":cur_imod_page", 1),
        (try_end),
      (try_end),
      (overlay_set_val, "$g_presentation_obj_admin_panel_4", 0),
      (assign, ":chosen_imod", 0),
      (assign, "$g_prsnt_param_3", ":chosen_imod"),
      ...
      (position_set_x, pos1, 2720),
      (position_set_y, pos1, 2720),
      (overlay_set_size, reg1, pos1),
      (position_set_x, pos1, 700+135),
      (position_set_y, pos1, 150+135),
      (overlay_set_position, reg1, pos1),
      ...
      (overlay_set_position, reg1, pos1),
      ## cheat: get the item
      (create_game_button_overlay, "$g_presentation_obj_admin_panel_7", "@CHEAT: Get it!"),
      (position_set_x, pos1, 840),
      (position_set_y, pos1, 100),
      (overlay_set_position, "$g_presentation_obj_admin_panel_7", pos1),
      (overlay_set_display, "$g_presentation_obj_admin_panel_7", 0),
      ...
      (try_begin),
        ...
        (try_for_range, ":item_no", 1, ":num_items"),
          (this_or_next|eq, "$g_only_show_merchandise", 0),
    ...
    (ti_on_presentation_mouse_enter_leave,[
      ...
      (assign, ":chosen_imod", "$g_prsnt_param_3"),
      ...
      (try_begin),
        ...
        (try_for_range, ":slot_no", 0, ":upper_bound"),
          ...
          (try_begin),
            (eq, ":slot_no", 0),
            (show_item_details_with_modifier, ":item_no", ":chosen_imod", pos0, 100),
          (else_try),
    ...
    (ti_on_presentation_event_state_change,[
      ...
      (try_for_range, ":slot_no", 0, ":upper_bound"),
        ...
        (try_begin),
          (eq, "$g_show_all_modifiers", 0),
          (overlay_set_display, "$g_presentation_obj_admin_panel_4", 0),
          (create_combo_button_overlay, "$g_presentation_obj_admin_panel_4"),
          (position_set_x, pos1, 840),
          (position_set_y, pos1, 500),
          (overlay_set_position, "$g_presentation_obj_admin_panel_4", pos1),
          ...
          (try_for_range, ":cur_imod_str", "str_imod_plain", "str_imod_end"),
            (store_sub, ":cur_imod", ":cur_imod_str", "str_imod_plain"),
            (this_or_next|eq, ":cur_imod", imod_plain),
            (item_has_modifier, ":item_no", ":cur_imod"),
            (overlay_add_item, "$g_presentation_obj_admin_panel_4", ":cur_imod_str"),
            (troop_set_slot, "trp_temp_array_d", ":cur_imod_page", ":cur_imod"),
            (val_add, ":cur_imod_page", 1),
          (try_end),
      ...
      (else_try),
        (eq, ":object", "$g_presentation_obj_admin_panel_2"),
        (assign, "$g_only_show_merchandise", ":value"),
        (start_presentation, "prsnt_all_items"),
      (else_try),
        (eq, ":object", "$g_presentation_obj_admin_panel_3"),
        (assign, "$g_show_all_modifiers", ":value"),
        (start_presentation, "prsnt_all_items"),
      (else_try),
        (eq, ":object", "$g_presentation_obj_admin_panel_4"),
        (troop_get_slot, ":chosen_imod", "trp_temp_array_d", ":value"),
        (assign, "$g_prsnt_param_3", ":chosen_imod"),
      (else_try),
        (eq, ":object", "$g_presentation_obj_admin_panel_7"),
        (troop_get_slot, ":cur_item_no", "trp_temp_array_c", 0),
        (troop_add_item, "trp_player", ":cur_item_no", ":chosen_imod"),
      (else_try),
        (eq, ":object", "$g_presentation_obj_admin_panel_5"),
        (presentation_set_duration, 0),
      (try_end),
  ...
  ###(((all_troops
  # temp_array_a: inventory_slot's overlay_id
  # temp_array_b: item's overlay_id
  # temp_array_c: troop id
  # temp_array_d: troop's overlay_id
  ("all_troops", 0, mesh_load_window, [
    (ti_on_presentation_load,[
      ...
      (assign, ":selected_troop", "$g_prsnt_param_1"),
      (assign, ":cur_page", "$g_prsnt_param_2"),
      (assign, ":num_troops", "$g_prsnt_param_3"),
      (assign, ":cheat_get_troop", "$g_prsnt_param_4"),
      ...
      ## troop id
      (assign, ":num_all_troops", len(troops)),
      (create_number_box_overlay, "$g_presentation_obj_admin_panel_9", 0, ":num_all_troops"),
      (position_set_x, pos1, 900),
      (position_set_y, pos1, 680),
      (overlay_set_position, "$g_presentation_obj_admin_panel_9", pos1),
      (overlay_set_val, "$g_presentation_obj_admin_panel_9", ":selected_troop"),

      (create_text_overlay, reg1, "@Troop ID:", tf_left_align),
      (position_set_x, pos1, 800),
      (position_set_y, pos1, 680),
      (overlay_set_position, reg1, pos1),
      ...
      (try_begin),
        (le, "$cheat_mode", 0),
        (overlay_set_display, reg1, 0),
        (overlay_set_display, "$g_presentation_obj_admin_panel_9", 0),
      (try_end),
      ...
      (position_set_y, pos1, 800),
      (overlay_set_size, "$g_presentation_obj_admin_panel_10", pos1),
      (overlay_add_item, "$g_presentation_obj_admin_panel_10", "@Heroes"),
      (overlay_add_item, "$g_presentation_obj_admin_panel_10", "@Soldiers"),
      (overlay_set_val, "$g_presentation_obj_admin_panel_10", ":cur_page"),

      (assign, ":num_troops", 0),
      (assign, ":cur_slot", 0),
      (try_begin),
        (eq, ":cur_page", 0), # Heroes
        (troop_set_slot, "trp_temp_array_c", ":cur_slot", "trp_player"),
        (val_add, ":num_troops", 1),
        (val_add, ":cur_slot", 1),
        (try_for_range, ":troop_no", heroes_begin, heroes_end),
          (neq, ":troop_no", "trp_knight_1_1_wife"),
          (this_or_next|neq, "$cheat_mode", 0),
          (troop_slot_eq, ":troop_no", slot_troop_met, 1),
          (troop_set_slot, "trp_temp_array_c", ":cur_slot", ":troop_no"),
          (val_add, ":num_troops", 1),
          (val_add, ":cur_slot", 1),
        (try_end),
      (else_try),
        (eq, ":cur_page", 1), # Soldiers
        (try_for_range, ":troop_no", soldiers_begin, soldiers_end),
          (neq, ":troop_no", "trp_mercenaries_end"),
          (neq, ":troop_no", "trp_kidnapped_girl"),
          (troop_set_slot, "trp_temp_array_c", ":cur_slot", ":troop_no"),
          (val_add, ":num_troops", 1),
          (val_add, ":cur_slot", 1),
        (try_end),
      ...
      (assign, ":pos_x", 0),
      (assign, ":pos_y", 20),
      (try_for_range_backwards, ":slot_no", 0, ":num_troops"),
        (troop_get_slot, ":troop_no", "trp_temp_array_c", ":slot_no"),
        (str_store_troop_name, s1, ":troop_no"),
        (create_button_overlay, reg1, s1, tf_left_align),
        (position_set_x, pos1, ":pos_x"),
        (position_set_y, pos1, ":pos_y"),
        (overlay_set_position, reg1, pos1),
        (position_set_x, pos1, 800),
      ...
      ## troop class
      (create_text_overlay, reg1, "@Class of troop", tf_center_justify|tf_vertical_align_center),
      (position_set_x, pos1, 675),
      (position_set_y, pos1, 300),
      (overlay_set_position, reg1, pos1),
      (position_set_x, pos1, 990),
      (position_set_y, pos1, 990),
      (overlay_set_size, reg1, pos1),
      ...
      (try_for_range_backwards, ":class_id", 0, 9),
        (str_store_class_name, s1, ":class_id"),
        (overlay_add_item, "$g_presentation_obj_admin_panel_5", s1),
      (try_end),
      ...
      ## get the troop
      (create_game_button_overlay, "$g_presentation_obj_admin_panel_7", "@CHEAT: Recruit:"),
      (position_set_x, pos1, 655),
      (position_set_y, pos1, 215),
      (overlay_set_position, "$g_presentation_obj_admin_panel_7", pos1),
      (position_set_x, pos1, 120),
      ...
      (position_set_y, pos1, 215),
      (overlay_set_position, "$g_presentation_obj_admin_panel_8", pos1),
      (overlay_set_val, "$g_presentation_obj_admin_panel_8", ":cheat_get_troop"),
      (overlay_set_display, "$g_presentation_obj_admin_panel_7", 0),
      ...
      (create_text_overlay, "$g_presentation_obj_admin_panel_11", "@CHEAT: Set relation:", tf_center_justify),
      (position_set_x, pos1, 640),
      (position_set_y, pos1, 215),
      (overlay_set_position, "$g_presentation_obj_admin_panel_11", pos1),
      (position_set_x, pos1, 600),
      ...
      (create_number_box_overlay, "$g_presentation_obj_admin_panel_12", -100, 101),
      (position_set_x, pos1, 705),
      (position_set_y, pos1, 215),
      (overlay_set_position, "$g_presentation_obj_admin_panel_12", pos1),
      (call_script, "script_troop_get_player_relation", ":selected_troop"),
      (assign, ":relation", reg0),
      (overlay_set_val, "$g_presentation_obj_admin_panel_12", ":relation"),

      (create_text_overlay, reg1, "@Relation with you: {reg0}", tf_center_justify),
      (position_set_x, pos1, 680),
      (position_set_y, pos1, 215),
      (overlay_set_position, reg1, pos1),
      (position_set_x, pos1, 900),
      ...
      (overlay_set_display, reg1, 0),
      (overlay_set_display, "$g_presentation_obj_admin_panel_11", 0),
      (overlay_set_display, "$g_presentation_obj_admin_panel_12", 0),
      (try_begin),
        (neq, ":selected_troop", "trp_player"),
        (troop_is_hero, ":selected_troop"),
        (overlay_set_display, reg1, 1),
        (gt, "$cheat_mode", 0),
        (overlay_set_display, reg1, 0),
        (overlay_set_display, "$g_presentation_obj_admin_panel_11", 1),
        (overlay_set_display, "$g_presentation_obj_admin_panel_12", 1),
      (try_end),

      ## troop
      (store_mul, ":troop_with_weapons", ":selected_troop", 2), #with weapons
      (create_mesh_overlay_with_tableau_material, reg1, -1, "tableau_game_party_window", ":troop_with_weapons"),
      (position_set_x, pos1, 750),
      (position_set_y, pos1, 1000),
      (overlay_set_size, reg1, pos1),
      (position_set_x, pos1, 560),
      ...
      (str_store_troop_name, s1, ":selected_troop"),
      (str_store_string, s2, s1),
      (store_character_level, reg0, ":selected_troop"),
      (str_store_string, s1, "@Level: {reg0}"),
      (str_store_string, s2, "@{s2}^{s1}"),
      (try_begin),
        (neg|troop_is_hero, ":selected_troop"),
      ...
      ## attributes
      (create_text_overlay, reg1, "@Attributes", tf_center_justify),
      (position_set_x, pos1, 440),
      (position_set_y, pos1, 680),
      (overlay_set_position, reg1, pos1),
      (overlay_set_color, reg1, 0x000088),
      (assign, ":pos_x", 440),
      (assign, ":pos_y", 650),
      (try_for_range, ":attribute_no", 0, 4),
        ...
        (create_text_overlay, reg1, "@{s1}: {reg0}", tf_center_justify),
        (position_set_x, pos1, ":pos_x"),
        (position_set_y, pos1, ":pos_y"),
        (overlay_set_position, reg1, pos1),
        (position_set_x, pos1, 980),
      ...
      ## skills
      (create_text_overlay, reg1, "@Skills", tf_center_justify),
      (position_set_x, pos1, 440),
      (position_set_y, pos1, 525),
      (overlay_set_position, reg1, pos1),
      (overlay_set_color, reg1, 0x008800),
      (assign, ":pos_x", 440),
      (assign, ":pos_y", 500),
      (try_for_range_backwards, ":skill_no", skl_trade, skl_reserved_14),
        (neg|is_between, ":skill_no", skl_reserved_1, skl_persuasion),
        (neg|is_between, ":skill_no", skl_reserved_5, skl_looting),
        (neg|is_between, ":skill_no", skl_reserved_9, skl_power_draw),
      ...
      ## Proficiencies
      (create_text_overlay, reg1, "@Proficiencies", tf_center_justify),
      (position_set_x, pos1, 675),
      (position_set_y, pos1, 175),
      (overlay_set_position, reg1, pos1),
      ...
      (assign, ":pos_x", 675),
      (assign, ":pos_y", 150),
      (try_for_range, ":proficiency_no", 0, 6),
        (store_proficiency_level, ":proficiency_level", ":selected_troop", ":proficiency_no"),
        (assign, reg0, ":proficiency_level"),
        (store_add, ":dest_text", "str_proficiency_one_handed_weapons", ":proficiency_no"),
        (str_store_string, s1, ":dest_text"),
        (create_text_overlay, reg1, "@{s1}: {reg0}", tf_center_justify),
        (position_set_x, pos1, ":pos_x"),
        (position_set_y, pos1, ":pos_y"),
      ...
      ## equipments
      (troop_get_inventory_capacity, ":inv_cap", ":selected_troop"),
      (troop_clear_inventory, "trp_temp_array_sort"),
      (try_for_range, ":i_slot", 0, ":inv_cap"),
        (troop_get_inventory_slot, ":item", ":selected_troop", ":i_slot"),
        (gt, ":item", -1),
        # (item_get_type, ":type", ":item"),
        # (neq, ":type", itp_type_goods),
        (troop_get_inventory_slot_modifier, ":imod", ":selected_troop", ":i_slot"),
        (troop_add_item,"trp_temp_array_sort",":item", ":imod"),
      (try_end),

      (create_text_overlay, reg1, "@Equipments", tf_center_justify),
      ...
      (try_for_range, ":unused_height", 0, 32),
        (try_for_range, ":unused_width", 0, 3),
          ...
          (troop_get_inventory_slot, ":item_no", "trp_temp_array_sort", ":slot_no"),
          (try_begin),
            (gt, ":item_no", -1),
            (create_mesh_overlay_with_item_id, reg1, ":item_no"),
            (position_set_x, pos1, 800),
    ...
    (ti_on_presentation_mouse_enter_leave,[
      ...
      (try_begin),
        ...
        (try_for_range, ":slot_no", 10, 106),
          (troop_slot_eq, "trp_temp_array_a", ":slot_no", ":object"),
          (troop_get_inventory_slot, ":item", "trp_temp_array_sort", ":slot_no"),
          (try_begin),
            (gt, ":item", -1),
            (troop_get_inventory_slot_modifier, ":imod", "trp_temp_array_sort", ":slot_no"),
            (troop_get_slot, ":target_obj", "trp_temp_array_b", ":slot_no"),
            (overlay_get_position, pos1, ":target_obj"),
            (show_item_details_with_modifier, ":item", ":imod", pos1, 100),
            (assign, "$g_current_opened_item_details", ":slot_no"),
          (try_end),
        (try_end),
      (else_try),
    ...
    (ti_on_presentation_event_state_change,[
        ...
        (try_for_range, ":slot_no", 0, ":num_troops"),
          (troop_slot_eq, "trp_temp_array_d", ":slot_no", ":object"),
          (troop_get_slot, ":selected_troop", "trp_temp_array_c", ":slot_no"),
          (assign, "$g_prsnt_param_1", ":selected_troop"),
          (start_presentation, "prsnt_all_troops"),
        (try_end),

        (assign, ":selected_troop_slot_no", 0),
        (try_for_range, ":slot_no", 0, ":num_troops"),
          (troop_slot_eq, "trp_temp_array_c", ":slot_no", ":selected_troop"),
          (assign, ":selected_troop_slot_no", ":slot_no"),
        (try_end),

        (try_begin),
          (eq, ":object", "$g_presentation_obj_admin_panel_3"),
          (val_sub, ":selected_troop_slot_no", 1),
          (val_max, ":selected_troop_slot_no", 0),
          (troop_get_slot, ":selected_troop", "trp_temp_array_c", ":selected_troop_slot_no"),
          (assign, "$g_prsnt_param_1", ":selected_troop"),
          (start_presentation, "prsnt_all_troops"),
        (else_try),
          (eq, ":object", "$g_presentation_obj_admin_panel_4"),
          (val_add, ":selected_troop_slot_no", 1),
          (store_sub, ":last_slot_no", ":num_troops", 1),
          (val_min, ":selected_troop_slot_no", ":last_slot_no"),
          (troop_get_slot, ":selected_troop", "trp_temp_array_c", ":selected_troop_slot_no"),
          (assign, "$g_prsnt_param_1", ":selected_troop"),
          (start_presentation, "prsnt_all_troops"),
        (else_try),
          (eq, ":object", "$g_presentation_obj_admin_panel_9"),
          (assign, ":selected_troop", ":value"),
          (assign, "$g_prsnt_param_1", ":selected_troop"),
          (start_presentation, "prsnt_all_troops"),
        (else_try),
          (eq, ":object", "$g_presentation_obj_admin_panel_10"),
        ...
        (else_try),
          (eq, ":object", "$g_presentation_obj_admin_panel_7"),
          (party_add_members, "p_main_party", ":selected_troop", ":cheat_get_troop"),
          (assign, reg0, ":cheat_get_troop"),
          (str_store_troop_name_plural, s1, ":selected_troop"),
          (display_message, "@CHEAT! You get {reg0} {s1}.", 0xFF0000),
        (else_try),
          (eq, ":object", "$g_presentation_obj_admin_panel_8"),
          (assign, ":cheat_get_troop", ":value"),
          (assign, "$g_prsnt_param_4", ":cheat_get_troop"),
        (else_try),
          (eq, ":object", "$g_presentation_obj_admin_panel_12"),
          (call_script, "script_troop_get_player_relation", ":selected_troop"),
          (assign, ":relation", reg0),
          (store_sub, ":difference",":value", ":relation"),
          (call_script, "script_change_player_relation_with_troop", ":selected_troop", ":difference"),
        (else_try),
          (eq, ":object", "$g_presentation_obj_admin_panel_1"),
          (try_begin),
  ...
  ###(((troop_trees
  ("troop_trees", 0, mesh_load_window, [
    (ti_on_presentation_load,[
      (presentation_set_duration, 999999),
      (set_fixed_point_multiplier, 1000),

      (assign, ":selected_page", "$g_prsnt_param_5"),
      (assign, "$g_presentation_next_presentation", -1),
  ...
  ("troop_tree", 0, mesh_load_window, [
    (ti_on_presentation_load, [
      (presentation_set_duration, 999999),
      (set_fixed_point_multiplier, 1000),
      
      (assign, ":party_window_troop", "$g_prsnt_param_5"),
      (assign, "$g_presentation_next_presentation", -1),
  ...
  ###(((auto_trade
  ("auto_trade", 0, mesh_double_windows, [
    (ti_on_presentation_load, [
      (presentation_set_duration, 999999),
      (set_fixed_point_multiplier, 1000),
      ...
      # auto-trade
      (create_game_button_overlay, "$g_presentation_obj_admin_panel_2", "@Sell equipments"),
      (position_set_x, pos1, 650),
      (position_set_y, pos1, 10),
      (overlay_set_position, "$g_presentation_obj_admin_panel_2", pos1),

      (create_game_button_overlay, "$g_presentation_obj_admin_panel_3", "@Sell goods"),
      (position_set_x, pos1, 350),
      (position_set_y, pos1, 10),
      (overlay_set_position, "$g_presentation_obj_admin_panel_3", pos1),

      (create_combo_label_overlay, "$g_presentation_obj_admin_panel_8"),
      (position_set_x, pos1, 433),
      (position_set_y, pos1, 55),
      (overlay_set_position, "$g_presentation_obj_admin_panel_8", pos1),
      (position_set_x, pos1, 500),
      (position_set_y, pos1, 1000),
      (overlay_set_size, "$g_presentation_obj_admin_panel_8", pos1),
      (overlay_add_item, "$g_presentation_obj_admin_panel_8", "@Sell all goods"),
      (overlay_add_item, "$g_presentation_obj_admin_panel_8", "@Don't sell foods"),
      (overlay_add_item, "$g_presentation_obj_admin_panel_8", "@Only sell foods"),
      (overlay_set_val, "$g_presentation_obj_admin_panel_8", "$g_auto_sell_goods_setting"),

      (create_game_button_overlay, "$g_presentation_obj_admin_panel_4", "@Buy goods"),
      (position_set_x, pos1, 150),
      (position_set_y, pos1, 10),
      (overlay_set_position, "$g_presentation_obj_admin_panel_4", pos1),

      (create_combo_label_overlay, "$g_presentation_obj_admin_panel_9"),
      ...
      (overlay_add_item, "$g_presentation_obj_admin_panel_9", "@Buy all goods"),
      (overlay_add_item, "$g_presentation_obj_admin_panel_9", "@Don't buy foods"),
      (overlay_add_item, "$g_presentation_obj_admin_panel_9", "@Only buy foods"),
      (overlay_set_val, "$g_presentation_obj_admin_panel_9", "$g_auto_buy_goods_setting"),

      # auto-trade settings for equipments
      (create_text_overlay, reg1, "@Auto-trade settings for equipments", tf_center_justify),
      (position_set_x, pos1, 750),
      (position_set_y, pos1, 713),
      (overlay_set_position, reg1, pos1),

      (create_text_overlay, reg1, "@^Sell equipments: Equipments in your inventory which fits the conditions below will be sold automaticly.", tf_scrollable|tf_double_space),
      (position_set_x, pos1, 550),
      ...
      (position_set_x, pos1, 530),
      (position_set_y, pos1, 544),
      (overlay_set_position, reg1, pos1),

      (create_number_box_overlay, "$g_presentation_obj_admin_panel_7", 0, 10000),
      (position_set_x, pos1, 850),
      (position_set_y, pos1, 530),
      (overlay_set_position, "$g_presentation_obj_admin_panel_7", pos1),
      (overlay_set_val, "$g_presentation_obj_admin_panel_7", "$g_auto_sell_price_limit"),
      ...
      (assign, ":pos_x", 530),
      (assign, ":pos_y", 410),
      (try_for_range, ":cur_type", itp_type_horse, itp_type_pistol),
        (neq, ":cur_type", itp_type_goods),
        # button
        (position_set_x, pos1, ":pos_x"),
        (position_set_y, pos1, ":pos_y"),
        ...
        (store_add, ":cur_string", "str_item_type_begin", ":cur_type"),
        (str_store_string, s1, ":cur_string"),
        ...
        (overlay_set_position, reg1, pos1),
        (item_get_slot, ":for_sell", ":cur_type", slot_item_type_for_sell),
      ...
      ## auto-sell equipments when leaving
      (create_text_overlay, reg1, "@Auto-sell equipments when leaving.", tf_vertical_align_center),
      ...
      (position_set_y, pos1, 70),
      (overlay_set_position, "$g_presentation_obj_admin_panel_10", pos1),
      (overlay_set_val, "$g_presentation_obj_admin_panel_10", "$g_auto_sell_equipments_when_leaving"),

      # auto-trade settings for goods
      (create_text_overlay, reg1, "@Auto-trade settings for goods", tf_center_justify),
      (position_set_x, pos1, 250),
      (position_set_y, pos1, 713),
      (overlay_set_position, reg1, pos1),

      (create_text_overlay, reg1, "@^Sell goods: Goods with max amount in your inventory which fits auto-sell conditions will be sold automaticly. Rotten foods will always be sold and abandoned.^^Buy goods: Goods with max amount of merchant which fits auto-buy conditions will be bought automaticly.\
^^Upper number box: Lower bound of auto-sell price for the item. Item won't be sold when set to 0.^^Lower number box: Upper bound of auto-buy price for the item. Item won't be bought when set to 0.", tf_scrollable|tf_double_space),
      (position_set_x, pos1, 50),
      (position_set_y, pos1, 580),
      (overlay_set_position, reg1, pos1),
      (position_set_x, pos1, 410),
      ...
      (assign, ":num_cols", 4),
      (store_sub, ":num_items", trade_goods_end, trade_goods_begin),
      (store_div, ":num_rows", ":num_items", 4),
      (store_mod, ":offset", ":num_items", 4),
      (val_min, ":offset", 1),
      (val_add, ":num_rows", ":offset"),
      (store_mul, ":pos_y", ":num_rows", ":row_adder"),
      (val_sub, ":pos_y", ":row_adder"),
      (val_add, ":pos_y", 25),
      (assign, ":pos_x", 0),
      ...
      (try_for_range, ":cur_item", trade_goods_begin, trade_goods_end),
        ...
        (overlay_set_position, reg1, pos1),
        # auto-sell price
        (create_number_box_overlay, reg1, 0, 10000),
        (store_add, ":box_x", ":pos_x", 10),
        (store_add, ":box_y", ":pos_y", 80),
        (position_set_x, pos1, ":box_x"),
        (position_set_y, pos1, ":box_y"),
        (overlay_set_position, reg1, pos1),
        (item_get_slot, ":auto_sell_price", ":cur_item", slot_item_auto_sell_price),
        (overlay_set_val, reg1, ":auto_sell_price"),
        (troop_set_slot, "trp_temp_array_c", ":cur_item", reg1),
        # auto-buy price
        (create_number_box_overlay, reg1, 0, 10000),
        (store_add, ":box_x", ":pos_x", 10),
        ...
        (position_set_y, pos1, ":box_y"),
        (overlay_set_position, reg1, pos1),
        (item_get_slot, ":auto_buy_price", ":cur_item", slot_item_auto_buy_price),
        (overlay_set_val, reg1, ":auto_buy_price"),
        (troop_set_slot, "trp_temp_array_d", ":cur_item", reg1),
        # next
      ...
      ## auto-sell goods when leaving
      (create_text_overlay, reg1, "@Auto-sell goods when leaving.", tf_vertical_align_center),
      ...
      (position_set_y, pos1, 130),
      (overlay_set_position, "$g_presentation_obj_admin_panel_11", pos1),
      (overlay_set_val, "$g_presentation_obj_admin_panel_11", "$g_auto_sell_goods_when_leaving"),
      ## auto-buy goods when leaving
      (create_text_overlay, reg1, "@Auto-buy goods when leaving.", tf_vertical_align_center),
      (position_set_x, pos1, 70),
      (position_set_y, pos1, 108),
      (overlay_set_position, reg1, pos1),
      (create_check_box_overlay, "$g_presentation_obj_admin_panel_12", "mesh_checkbox_off", "mesh_checkbox_on"),
      (position_set_x, pos1, 50),
      (position_set_y, pos1, 100),
      (overlay_set_position, "$g_presentation_obj_admin_panel_12", pos1),
      (overlay_set_val, "$g_presentation_obj_admin_panel_12", "$g_auto_buy_goods_when_leaving"),
    ]),
    ...
    (ti_on_presentation_event_state_change, [
      ...
      (assign, ":continue", 1),
      ## check boxes
      (try_for_range, ":item_type", itp_type_horse, itp_type_pistol),
        (neq, ":item_type", itp_type_goods),
        (troop_slot_eq, "trp_temp_array_b", ":item_type", ":object"),
        (assign, ":for_sell", ":value"),
        (item_set_slot, ":item_type", slot_item_type_for_sell, ":for_sell"),
        (assign, ":continue", 0),
      (try_end),
      ...
      (try_for_range, ":cur_item", trade_goods_begin, trade_goods_end),
        ...
        (item_set_slot, ":cur_item", slot_item_auto_sell_price, ":value"),
        (assign, ":continue", 0),
      (try_end),
      (eq, ":continue", 1),
      (try_for_range, ":cur_item", trade_goods_begin, trade_goods_end),
        (troop_slot_eq, "trp_temp_array_d", ":cur_item", ":object"),
        (item_set_slot, ":cur_item", slot_item_auto_buy_price, ":value"),
        (assign, ":continue", 0),
      (try_end),
      ...
      (try_begin), # back
        (eq, ":object", "$g_presentation_obj_admin_panel_1"),
        (presentation_set_duration, 0),
      (else_try), # auto-sell equipments
        (eq, ":object", "$g_presentation_obj_admin_panel_2"),
        (call_script, "script_auto_sell", 0),
      (else_try), # auto-sell goods
        (eq, ":object", "$g_presentation_obj_admin_panel_3"),
        (call_script, "script_auto_sell", 1),
      (else_try), # auto-buy goods
        (eq, ":object", "$g_presentation_obj_admin_panel_4"),
      ...
      (else_try),
        (eq, ":object", "$g_presentation_obj_admin_panel_8"),
        (assign, "$g_auto_sell_goods_setting", ":value"),
      (else_try),
        (eq, ":object", "$g_presentation_obj_admin_panel_9"),
        (assign, "$g_auto_buy_goods_setting", ":value"),
      (else_try),
        (eq, ":object", "$g_presentation_obj_admin_panel_10"),
        (assign, "$g_auto_sell_equipments_when_leaving", ":value"),
      (else_try),
        (eq, ":object", "$g_presentation_obj_admin_panel_11"),
        (assign, "$g_auto_sell_goods_when_leaving", ":value"),
      (else_try),
        (eq, ":object", "$g_presentation_obj_admin_panel_12"),
        (assign, "$g_auto_buy_goods_when_leaving", ":value"),
      (else_try), # select all
        (eq, ":object", "$g_presentation_obj_admin_panel_5"),
        (try_for_range, ":cur_type", itp_type_horse, itp_type_pistol),
          (item_set_slot, ":cur_type", slot_item_type_for_sell, 1),
          (troop_get_slot, ":checkbox", "trp_temp_array_b", ":cur_type"),
          (overlay_set_val, ":checkbox", 1),
        (try_end),
      (else_try), # select invert
        (eq, ":object", "$g_presentation_obj_admin_panel_6"),
        (try_for_range, ":cur_type", itp_type_horse, itp_type_pistol),
          (item_set_slot, ":cur_type", slot_item_type_for_sell, 0),
          (troop_get_slot, ":checkbox", "trp_temp_array_b", ":cur_type"),
          (overlay_set_val, ":checkbox", 0),
        (try_end),
      (try_end),
    ]),
    ...
    (ti_on_presentation_mouse_enter_leave, [
      ...
      (try_begin),
        ...
        (try_for_range, ":cur_item", trade_goods_begin, trade_goods_end),
          ...
          (position_set_x, pos1, ":item_x"),
          (position_set_y, pos1, ":item_y"),
          (show_item_details, ":cur_item", pos1, 100),
          (assign, "$g_current_opened_item_details", ":cur_item"),
        (try_end),
      (else_try),
        (try_for_range, ":cur_item", trade_goods_begin, trade_goods_end),
          (troop_slot_eq, "trp_temp_array_a", ":cur_item", ":object"),
          (try_begin),
            (eq, "$g_current_opened_item_details", ":cur_item"),
            (close_item_details),
          (try_end),
        (try_end),
      (try_end),
  ...
  ("battle_map", prsntf_read_only, 0, [
    (ti_on_presentation_load, [
      ...
      (try_begin),
        ...
        (ge, ":player_chest", 0),
        (create_mesh_overlay, "$g_player_chest_obj", "mesh_white_plane"),
        (overlay_set_color, "$g_player_chest_obj", 0xFF00FF),
        (position_set_x, pos1, 250),
        (position_set_y, pos1, 250),
        (overlay_set_size, "$g_player_chest_obj", pos1),
      (try_end),
    ...
    (ti_on_presentation_run, [
      ...
      (gt, ":cur_time", 200),
      (try_begin),
        (this_or_next|key_clicked, "$game_key_battle_map"),
        (game_key_clicked, gk_view_orders),
        (try_for_agents, ":cur_agent"),
          (agent_set_slot, ":cur_agent", slot_agent_map_overlay_id, 0),
        (try_end),
  ...
  ("sort_troops", 0, mesh_load_window,[
    (ti_on_presentation_load, [ 
      ...
      # (assign, ":party_no", "$g_prsnt_param_1"),
      (assign, ":sort_prisoners", "$g_prsnt_param_2"),
      (assign, ":ascending", "$g_prsnt_param_3"),
      (assign, ":selected_ord", "$g_prsnt_param_4"),
      (assign, ":selected_ord_type", "$g_prsnt_param_5"),

      (create_combo_label_overlay, "$g_presentation_obj_admin_panel_4"),
      (position_set_x, pos1, 500),
      (position_set_y, pos1, 650),
      (overlay_set_position, "$g_presentation_obj_admin_panel_4", pos1),
      (overlay_add_item, "$g_presentation_obj_admin_panel_4", "@Sort Garrison"),
      (overlay_add_item, "$g_presentation_obj_admin_panel_4", "@Sort Prisoners"),
      (overlay_set_val, "$g_presentation_obj_admin_panel_4", ":sort_prisoners"),
      ...
      (create_game_button_overlay, "$g_presentation_obj_admin_panel_1", "@By Faction"),
      (position_set_x, pos1, 250),
      (position_set_y, pos1, 550),
      (overlay_set_position, "$g_presentation_obj_admin_panel_1", pos1),

      (create_game_button_overlay, "$g_presentation_obj_admin_panel_2", "@By Level"),
      (position_set_x, pos1, 500),
      (position_set_y, pos1, 550),
      (overlay_set_position, "$g_presentation_obj_admin_panel_2", pos1),

      (create_game_button_overlay, "$g_presentation_obj_admin_panel_3", "@By Class"),
      (position_set_x, pos1, 750),
      (position_set_y, pos1, 550),
      (overlay_set_position, "$g_presentation_obj_admin_panel_3", pos1),

      ## level decending or ascending
      (create_combo_label_overlay, "$g_presentation_obj_admin_panel_6"),
      (position_set_x, pos1, 585),
      (position_set_y, pos1, 500),
      (overlay_set_position, "$g_presentation_obj_admin_panel_6", pos1),
      (position_set_x, pos1, 500),
      ...
      (overlay_add_item, "$g_presentation_obj_admin_panel_6", "@Decending"),
      (overlay_add_item, "$g_presentation_obj_admin_panel_6", "@Ascending"),
      (overlay_set_val, "$g_presentation_obj_admin_panel_6", ":ascending"),

      ## facton order
      (create_text_overlay, reg1, "@Order of Factions:", tf_center_justify),
      (position_set_x, pos1, 250),
      (position_set_y, pos1, 500),
      (overlay_set_position, reg1, pos1),
      ...
      (try_for_range, ":faction_ord", 0, 11),
        (troop_get_slot, ":cur_faction", ":faction_ord", slot_troop_faction_order),
        (try_begin),
          (eq, ":cur_faction", fac_player_supporters_faction),
          (str_store_string, s1, "@Heroes"),
        (else_try),
          (eq, ":cur_faction", fac_no_faction),
        ...
        (position_set_y, pos1, ":pos_y"),
        (overlay_set_position, reg1, pos1),
        (troop_set_slot, "trp_temp_array_a", ":faction_ord", reg1),
        (val_sub, ":pos_y", ":offset"),
        (eq, ":selected_ord_type", 0),
        (eq, ":selected_ord", ":faction_ord"),
        (overlay_set_alpha, reg1, 0x80),
      (try_end),

      (create_game_button_overlay, "$g_presentation_obj_admin_panel_7", "@Move Up"),
      (position_set_x, pos1, 425),
      (position_set_y, pos1, 150),
      (overlay_set_position, "$g_presentation_obj_admin_panel_7", pos1),
      (create_game_button_overlay, "$g_presentation_obj_admin_panel_8", "@Move Down"),
      (position_set_x, pos1, 425),
      (position_set_y, pos1, 100),
      (overlay_set_position, "$g_presentation_obj_admin_panel_8", pos1),

      ## class order
      (create_text_overlay, reg1, "@Order of Classes:", tf_center_justify),
      (position_set_x, pos1, 750),
      (position_set_y, pos1, 500),
      (overlay_set_position, reg1, pos1),
      ...
      (try_for_range, ":class_ord", 0, 9),
        (troop_get_slot, ":cur_class", ":class_ord", slot_troop_class_order),
        (str_store_class_name, s1, ":cur_class"),
        (create_game_button_overlay, reg1, s1),
        (position_set_x, pos1, ":pos_x"),
        (position_set_y, pos1, ":pos_y"),
        (overlay_set_position, reg1, pos1),
        (troop_set_slot, "trp_temp_array_b", ":class_ord", reg1),
        (val_sub, ":pos_y", ":offset"),
        (eq, ":selected_ord_type", 1),
        (eq, ":selected_ord", ":class_ord"),
        (overlay_set_alpha, reg1, 0x80),
      (try_end),

      (create_game_button_overlay, "$g_presentation_obj_admin_panel_9", "@Move Up"),
      (position_set_x, pos1, 575),
      (position_set_y, pos1, 150),
      (overlay_set_position, "$g_presentation_obj_admin_panel_9", pos1),
      (create_game_button_overlay, "$g_presentation_obj_admin_panel_10", "@Move Down"),
      (position_set_x, pos1, 575),
      (position_set_y, pos1, 100),
      (overlay_set_position, "$g_presentation_obj_admin_panel_10", pos1),
    ]),
    ...
    (ti_on_presentation_event_state_change, [
      ...
      (assign, ":selected_obj", -1),
      (try_begin),
        (eq, ":selected_ord_type", 0),
        (troop_get_slot, ":selected_obj", "trp_temp_array_a", ":selected_ord"),
      (else_try),
        (eq, ":selected_ord_type", 1),
        (troop_get_slot, ":selected_obj", "trp_temp_array_b", ":selected_ord"),
      (try_end),

      (try_for_range, ":faction_ord", 0, 11),
        (troop_get_slot, ":faction_obj", "trp_temp_array_a", ":faction_ord"),
        (eq, ":faction_obj", ":object"),
        (try_begin),
          (gt, ":selected_obj", -1),
          (overlay_set_alpha, ":selected_obj", 0xff),
        (try_end),
        (assign, ":selected_ord", ":faction_ord"),
        (assign, "$g_prsnt_param_4", ":selected_ord"),
        (assign, ":selected_ord_type", 0),
        (assign, "$g_prsnt_param_5", ":selected_ord_type"),
        (overlay_set_alpha, ":faction_obj", 0x80),
      (try_end),

      (try_for_range, ":class_ord", 0, 9),
        (troop_get_slot, ":class_obj", "trp_temp_array_b", ":class_ord"),
        (eq, ":class_obj", ":object"),
        (try_begin),
          (gt, ":selected_obj", -1),
          (overlay_set_alpha, ":selected_obj", 0xff),
        (try_end),
        (assign, ":selected_ord", ":class_ord"),
        (assign, "$g_prsnt_param_4", ":selected_ord"),
        (assign, ":selected_ord_type", 1),
        (assign, "$g_prsnt_param_5", ":selected_ord_type"),
        (overlay_set_alpha, ":class_obj", 0x80),
      (try_end),

      (assign, ":faction_order_change", 0),
      (assign, ":class_order_change", 0),
      ...
      (else_try),
        (eq, ":object", "$g_presentation_obj_admin_panel_1"),
        (call_script, "script_sort_troops_by_faction", ":party_no", ":sort_prisoners"),
      (else_try),
        (eq, ":object", "$g_presentation_obj_admin_panel_2"),
        (call_script, "script_sort_troops_by_level", ":party_no", ":sort_prisoners", ":ascending"),
      (else_try),
        (eq, ":object", "$g_presentation_obj_admin_panel_3"),
        (call_script, "script_sort_troops_by_class", ":party_no", ":sort_prisoners"),
      (else_try),
        (eq, ":object", "$g_presentation_obj_admin_panel_4"),
        (assign, ":sort_prisoners", ":value"),
        (assign, "$g_prsnt_param_2", ":sort_prisoners"),
      (else_try),
        (eq, ":object", "$g_presentation_obj_admin_panel_6"),
        (assign, ":ascending", ":value"),
        (assign, "$g_prsnt_param_3", ":ascending"),
      (else_try),
        (eq, ":object", "$g_presentation_obj_admin_panel_7"),
        (eq, ":selected_ord_type", 0),
        (is_between, ":selected_ord", 1, 11),
        (store_sub, ":dest_ord", ":selected_ord", 1),
        # (val_clamp, ":dest_ord", 0, 11),
        (assign, ":faction_order_change", 1),
      (else_try),
        (eq, ":object", "$g_presentation_obj_admin_panel_8"),
        (eq, ":selected_ord_type", 0),
        (is_between, ":selected_ord", 0, 10),
        (store_add, ":dest_ord", ":selected_ord", 1),
        # (val_clamp, ":dest_ord", 0, 11),
        (assign, ":faction_order_change", 1),
      (else_try),
        (eq, ":object", "$g_presentation_obj_admin_panel_9"),
        (eq, ":selected_ord_type", 1),
        (is_between, ":selected_ord", 1, 9),
        (store_sub, ":dest_ord", ":selected_ord", 1),
        # (val_clamp, ":dest_ord", 0, 9),
        (assign, ":class_order_change", 1),
      (else_try),
        (eq, ":object", "$g_presentation_obj_admin_panel_10"),
        (eq, ":selected_ord_type", 1),
        (is_between, ":selected_ord", 0, 8),
        (store_add, ":dest_ord", ":selected_ord", 1),
        # (val_clamp, ":dest_ord", 0, 9),
        (assign, ":class_order_change", 1),
      (try_end),
      ...
      (try_begin),
        (eq, ":faction_order_change", 1),
        (troop_get_slot, ":faction_1", ":selected_ord", slot_troop_faction_order),
        (troop_get_slot, ":faction_2", ":dest_ord", slot_troop_faction_order),
        (troop_set_slot, ":selected_ord", slot_troop_faction_order, ":faction_2"),
        (troop_set_slot, ":dest_ord", slot_troop_faction_order, ":faction_1"),
        (assign, ":selected_ord", ":dest_ord"),
        (assign, "$g_prsnt_param_4", ":selected_ord"),
        (start_presentation, "prsnt_sort_troops"),
      (try_end),

      (try_begin),
        (eq, ":class_order_change", 1),
        (troop_get_slot, ":class_1", ":selected_ord", slot_troop_class_order),
        (troop_get_slot, ":class_2", ":dest_ord", slot_troop_class_order),
        (troop_set_slot, ":selected_ord", slot_troop_class_order, ":class_2"),
        (troop_set_slot, ":dest_ord", slot_troop_class_order, ":class_1"),
        (assign, ":selected_ord", ":dest_ord"),
        (assign, "$g_prsnt_param_4", ":selected_ord"),
        (start_presentation, "prsnt_sort_troops"),
      (try_end),
    ...
    (ti_on_presentation_run, [
      ...
      (try_begin),
        ...
        (overlay_set_display, "$g_presentation_obj_admin_panel_8", 1),
        (overlay_set_display, "$g_presentation_obj_admin_panel_9", 0),
        (overlay_set_display, "$g_presentation_obj_admin_panel_10", 0),
      (else_try),
        (eq, ":selected_ord_type", 1),
        (overlay_set_display, "$g_presentation_obj_admin_panel_7", 0),
        (overlay_set_display, "$g_presentation_obj_admin_panel_8", 0),
        (overlay_set_display, "$g_presentation_obj_admin_panel_9", 1),
        (overlay_set_display, "$g_presentation_obj_admin_panel_10", 1),
      (else_try),
        (overlay_set_display, "$g_presentation_obj_admin_panel_7", 0),
        (overlay_set_display, "$g_presentation_obj_admin_panel_8", 0),
        (overlay_set_display, "$g_presentation_obj_admin_panel_9", 0),
  ...
  ("mod_options", 0, mesh_load_window, [
    (ti_on_presentation_load, [
      ...
      (assign, ":offset_x", 350),
      (assign, ":offset_y", 50),
      (create_text_overlay, reg1, "@Set Mod Keys:", tf_left_align),
      (position_set_x, pos1, ":pos_x"),
      (position_set_y, pos1, ":pos_y"),
      (overlay_set_position, reg1, pos1),
      (position_set_x, pos1, 1500),
      ...
      (create_text_overlay, "$g_presentation_obj_admin_panel_2", "@Press a key", tf_center_justify),
      (val_add, ":pos_x", ":offset_x"),
      (position_set_x, pos1, ":pos_x"),
      (position_set_y, pos1, ":pos_y"),
      (overlay_set_position, "$g_presentation_obj_admin_panel_2", pos1),
      (val_sub, ":pos_x", ":offset_x"),
      (position_set_x, pos1, 1500),
      (position_set_y, pos1, 1500),
      (overlay_set_size, "$g_presentation_obj_admin_panel_2", pos1),
      (overlay_set_display, "$g_presentation_obj_admin_panel_2", 0),
      ...
      ## battle map
      (val_sub, ":pos_y", ":offset_y"),
      (create_text_overlay, reg1, "@Battle Map:", tf_left_align),
      (position_set_x, pos1, ":pos_x"),
      (position_set_y, pos1, ":pos_y"),
      (overlay_set_position, reg1, pos1),
      (try_for_range, ":cur_slot", 0, len(keys)),
        (troop_get_slot, ":key_no", "trp_temp_array_a", ":cur_slot"),
        (eq, ":key_no", "$game_key_battle_map"),
        (store_add, ":dest_string", "str_key_1", ":cur_slot"),
        (str_store_string, s1, ":dest_string"),
      (try_end),

      (create_game_button_overlay, "$g_presentation_obj_admin_panel_3", s1),
      (val_add, ":pos_x", ":offset_x"),
      (position_set_x, pos1, ":pos_x"),
      (position_set_y, pos1, ":pos_y"),
      (overlay_set_position, "$g_presentation_obj_admin_panel_3", pos1),
      ...
      ## manage inventory
      (val_sub, ":pos_y", ":offset_y"),
      (create_text_overlay, reg1, "@Manage Inventory:", tf_left_align),
      (position_set_x, pos1, ":pos_x"),
      (position_set_y, pos1, ":pos_y"),
      (overlay_set_position, reg1, pos1),
      (try_for_range, ":cur_slot", 0, len(keys)),
        (troop_get_slot, ":key_no", "trp_temp_array_a", ":cur_slot"),
        (eq, ":key_no", "$game_key_manage_inventory"),
        (store_add, ":dest_string", "str_key_1", ":cur_slot"),
        (str_store_string, s1, ":dest_string"),
      (try_end),

      (create_game_button_overlay, "$g_presentation_obj_admin_panel_4", s1),
      (val_add, ":pos_x", ":offset_x"),
      (position_set_x, pos1, ":pos_x"),
      (position_set_y, pos1, ":pos_y"),
      (overlay_set_position, "$g_presentation_obj_admin_panel_4", pos1),
      ...
      (val_sub, ":pos_y", ":offset_y"),
      (val_sub, ":pos_y", ":offset_y"),
      (create_text_overlay, reg1, "@Game Options:", tf_left_align),
      (position_set_x, pos1, ":pos_x"),
      (position_set_y, pos1, ":pos_y"),
      (overlay_set_position, reg1, pos1),
      (position_set_x, pos1, 1500),
      ...
      (val_sub, ":pos_y", ":offset_y"),
      (create_text_overlay, reg1, "@Auto-take captured enemies:", tf_left_align),
      (position_set_x, pos1, ":pos_x"),
      (position_set_y, pos1, ":pos_y"),
      (overlay_set_position, reg1, pos1),

      (create_check_box_overlay, "$g_presentation_obj_admin_panel_6", "mesh_checkbox_off", "mesh_checkbox_on"),
      (val_add, ":pos_x", ":offset_x"),
      (position_set_x, pos1, ":pos_x"),
      (position_set_y, pos1, ":pos_y"),
      (val_sub, ":pos_x", ":offset_x"),
      (overlay_set_position, "$g_presentation_obj_admin_panel_6", pos1),
      (overlay_set_val, "$g_presentation_obj_admin_panel_6", "$g_auto_take_captured_enemies"),
      ###)))
      ...
      (assign, ":offset_x", 350),
      (assign, ":offset_y", 50),
      (create_text_overlay, reg1, "@Cheat Options:", tf_left_align),
      (position_set_x, pos1, ":pos_x"),
      (position_set_y, pos1, ":pos_y"),
      (overlay_set_position, reg1, pos1),
      (position_set_x, pos1, 1500),
      ...
      ###(((npc_complaints
      (val_sub, ":pos_y", ":offset_y"),
      (create_text_overlay, reg1, "@Disable NPCs' complaints:", tf_left_align),
      (position_set_x, pos1, ":pos_x"),
      (position_set_y, pos1, ":pos_y"),
      (overlay_set_position, reg1, pos1),
      ...
      (overlay_set_position, "$g_presentation_obj_admin_panel_10", pos1),
      (val_sub, ":pos_x", ":offset_x"),
      (overlay_set_val, "$g_presentation_obj_admin_panel_10", "$disable_npc_complaints"),
      ###)))

      ###(((hero_escape_after_defeat_chance
      (val_sub, ":pos_y", ":offset_y"),
      (create_text_overlay, reg1, "@Escape chance of defeated hero:", tf_left_align),
      (position_set_x, pos1, ":pos_x"),
      (position_set_y, pos1, ":pos_y"),
      (overlay_set_position, reg1, pos1),

      (create_number_box_overlay, "$g_presentation_obj_admin_panel_11", 0, 100),
      (val_add, ":pos_x", ":offset_x"),
      (position_set_x, pos1, ":pos_x"),
      (position_set_y, pos1, ":pos_y"),
      (overlay_set_position, "$g_presentation_obj_admin_panel_11", pos1),
      (val_sub, ":pos_x", ":offset_x"),
      (overlay_set_val, "$g_presentation_obj_admin_panel_11", "$hero_escape_after_defeat_chance"),
      ###)))

      ###(((prisoner_heroes_can_not_escape
      (val_sub, ":pos_y", ":offset_y"),
      (create_text_overlay, reg1, "@Your prisoner heroes can't escape:", tf_left_align),
      (position_set_x, pos1, ":pos_x"),
      (position_set_y, pos1, ":pos_y"),
      (overlay_set_position, reg1, pos1),
      ...
      (overlay_set_position, "$g_presentation_obj_admin_panel_12", pos1),
      (val_sub, ":pos_x", ":offset_x"),
      (overlay_set_val, "$g_presentation_obj_admin_panel_12", "$prisoner_heroes_can_not_escape"),
      ###)))
    ]),
      ...
      (else_try),
        ...
        (try_for_range, ":cur_slot", 0, len(keys)),
          ...
          (try_begin),
            ...
            (assign, "$game_key_battle_map", ":key_no"),
            (store_add, ":dest_string", "str_key_1", ":cur_slot"),
            (str_store_string, s1, ":dest_string"),
            (overlay_set_text, "$g_presentation_obj_admin_panel_3", s1),
          ...
          (else_try),
            ...
            (assign, "$game_key_manage_inventory", ":key_no"),
            (store_add, ":dest_string", "str_key_1", ":cur_slot"),
            (str_store_string, s1, ":dest_string"),
            (overlay_set_text, "$g_presentation_obj_admin_panel_4", s1),
    ...
    (ti_on_presentation_event_state_change,[
      ...
      (else_try),
        (gt, "$cheat_mode", 0),
        (eq, ":object", "$g_presentation_obj_admin_panel_11"),
        (assign, "$hero_escape_after_defeat_chance", ":value"),
      ###)))
      ###(((prisoner_heroes_can_not_escape
      (else_try),
        (gt, "$cheat_mode", 0),
        (eq, ":object", "$g_presentation_obj_admin_panel_12"),
        (assign, "$prisoner_heroes_can_not_escape", ":value"),
      ###)))
      (try_end),
    ]),
  ]),
