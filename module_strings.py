...
#multiplayer game type names
  ...
  ("lord_info_string", "{reg6?:{reg4?{s54} is the ruler of {s56}.^:{s54} is a vassal of {s55} of {s56}.^}}Renown: {reg5}. Controversy: {reg15}. Personality: {s61}.^{reg9?{reg3?She:He} is the {reg3?lady:lord} of {s58}.:{reg3?She:He} has no fiefs.}{s59}^{s49}"), ###(((lord_reputation_type # add:{ Personality: {s61}.})))
...
("the_coast", "the coast"),
  ...
  ("key_left_mouse_button", "Left Mouse Btn"),
  ("key_right_mouse_button", "Right Mouse Btn"),
  ("key_middle_mouse_button", "Middle Mouse Btn"),
  ("key_mouse_button_4", "Mouse Btn 4"),
  ("key_mouse_button_5", "Mouse Btn 5"),
  ("key_mouse_button_6", "Mouse Btn 6"),
  ("key_mouse_button_7", "Mouse Btn 7"),
  ("key_mouse_button_8", "Mouse Btn 8"),
  ("key_mouse_scroll_up", "Scroll Up"),
  ("key_mouse_scroll_down", "Scroll Down"),
  ###)))
  ###(((all_items
  ("imod_plain","Plain"),
  ...
  ###)))
  ###(((auto_trade
  ("item_type_begin","{!}item type begin"), #0
  ("item_type_horse","Horse"), #1 to compatibility with header_items (item type 1 is horse)
  ("item_type_one_handed_wpn","One Handed Weapon"), #2
  ("item_type_two_handed_wpn","Two Handed Weapon"),  #3
  ("item_type_polearm","Polearm"), #4
  ("item_type_arrows","Arrows"), #5
  ("item_type_bolts","Bolts"), #6
  ("item_type_shield","Shield"), #7
  ("item_type_bow","Bow"), #8
  ("item_type_crossbow","Crossbow"), #9
  ("item_type_thrown","Throwing Weapon"), #10
  ("item_type_goods", "Goods"), #11
  ("item_type_head_armor", "Head Armor"), #12
  ("item_type_body_armor", "Body Armor"), #13
  ("item_type_foot_armor", "Foot Armor"), #14
  ("item_type_hand_armor", "Hand Armor"), #15
  ("item_type_pistol", "Pistol"), #16
  ("item_type_musket", "Musket"), #17
  ("item_type_bullets", "Bullets"), #18
  ("item_type_animal", "Animal"), #19
  ("item_type_book", "Book"), #20
  ###)))
  ###(((all_troops
...
]+[("skl_"+skills[x][0], skills[x][1]) for x in range(0, len(skills))] ###(((all_troops)))