...
# These are used as arrays in the scripts.
  ...
  ["temp_array_x","{!}temp_array_x","{!}temp_array_x",tf_hero|tf_inactive, 0,reserved,  fac_neutral,[],def_attrib,0,knows_common, 0],
  ["temp_array_y","{!}temp_array_y","{!}temp_array_y",tf_hero|tf_inactive, 0,reserved,  fac_neutral,[],def_attrib,0,knows_common, 0],
  # ["temp_troop","Temp Troop","Temp Troop",tf_hero,no_scene,reserved,fac_commoners,[],def_attrib,0,knows_common|knows_inventory_management_10,0],
  ["temp_array_lock","{!}temp_array_lock","{!}temp_array_lock",tf_hero|tf_inactive, 0,reserved,  fac_neutral,[],def_attrib,0,knows_common|knows_inventory_management_10, 0],
  ["temp_array_sort","{!}temp_array_sort","{!}temp_array_sort",tf_hero|tf_inactive, 0,reserved,  fac_neutral,[],def_attrib,0,knows_common|knows_inventory_management_10, 0],
  ###)))
